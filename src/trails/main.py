...
def main():
    ...
    #start_date = datetime.datetime(2025, 7, 4)
    #end_date   = datetime.datetime(2025, 7, 5)  # Example: 7 days
    
    start_date = datetime.datetime.strptime(config['time']['begin'], '%Y-%m-%d')
    end_date = datetime.datetime.strptime(config['time']['end'], '%Y-%m-%d')
